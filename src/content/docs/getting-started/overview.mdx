...
The default HTTP scaffold keeps the application bootstrap files at the root of
`src/`:
...
2.  **[Quick Start](/getting-started/quick-start/)**: Build your first app and inspect the generated scaffold.
