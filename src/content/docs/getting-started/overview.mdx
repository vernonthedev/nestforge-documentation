...
<CardGrid>
  <Card title="Application Developer" icon="rocket">
    Learn how to build scalable server-side applications with NestForge. [Get
    Started](/getting-started/quick-start/)
  </Card>
  <Card title="Framework Contributor" icon="setting">
    Help us build the future of Rust backend development. [View Internal
    Docs](/framework/contributing/)
  </Card>
</CardGrid>
