...
Feature folders such as `src/users/` are generated later when you add modules or
resources.
...
- [Quick Start](/getting-started/quick-start/) — build and run your first app
- [CLI Workflow](/getting-started/cli-workflow/) — current generator and export commands
