...
That scaffold enables the required feature flag and wires the docs routes into
the generated bootstrap so you can start from a working OpenAPI project.
...
If you also use `.with_version("v1")`, the generated docs routes will follow the
...
2. Access the OpenAPI JSON: [http://localhost:3000/api/openapi.json](http://localhost:3000/api/openapi.json)
3. Access the Documentation UI: [http://localhost:3000/api/docs](http://localhost:3000/api/docs)
